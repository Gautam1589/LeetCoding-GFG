<h2>  Binary Tree Postorder Traversal</h2><hr><div style="user-select: auto;"><p style="user-select: auto;">Given the <code style="user-select: auto;">root</code> of a&nbsp;binary tree, return <em style="user-select: auto;">the postorder traversal of its nodes' values</em>.</p>

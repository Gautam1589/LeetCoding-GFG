<h2>  Lowest Common Ancestor of a Binary Tree</h2><hr><div style="user-select: auto;"><p style="user-select: auto;">Given a binary tree, find the lowest common ancestor (LCA) of two given nodes in the tree.</p>
